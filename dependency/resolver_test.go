...
func TestResolveLocalShallow(t *testing.T) {
	...
	expect := []string{
		...
		filepath.FromSlash("github.com/urfav/cli"),
	}
...
func TestResolve(t *testing.T) {
	...
	l, err := r.Resolve("github.com/urfav/cli", base)
	if err != nil {
		t.Fatalf("Failed to resolve: %s", err)
	}
	...
	if !strings.HasSuffix(filepath.FromSlash("github.com/urfav/cli"), l[0]) {
